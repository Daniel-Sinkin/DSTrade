...
def test_get_time_series_intraday() -> None:
    ...
    assert (
        handler.get_time_series_intraday(
...
def test_get_time_series_daily() -> None:
    ...
    assert (
        handler.get_time_series_daily(symbol="TSCO.LON", outputsize="full") is not None
    )
    assert (
        handler.get_time_series_daily(symbol="SHOP.TRT", outputsize="full") is not None
    )
    assert (
        handler.get_time_series_daily(symbol="GPV.TRV", outputsize="full") is not None
    )
    assert (
        handler.get_time_series_daily(symbol="MBG.DEX", outputsize="full") is not None
    )
    assert (
        handler.get_time_series_daily(symbol="RELIANCE.BSE", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily(symbol="600104.SHH", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily(symbol="000002.SHZ", outputsize="full")
        is not None
    )
...
def test_get_time_series_daily_adjusted() -> None:
    ...
    assert (
        handler.get_time_series_daily_adjusted(symbol="IBM", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily_adjusted(symbol="TSCO.LON", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily_adjusted(symbol="SHOP.TRT", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily_adjusted(symbol="GPV.TRV", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily_adjusted(symbol="MBG.DEX", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily_adjusted(symbol="RELIANCE.BSE", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily_adjusted(symbol="600104.SHH", outputsize="full")
        is not None
    )
    assert (
        handler.get_time_series_daily_adjusted(symbol="000002.SHZ", outputsize="full")
        is not None
    )
...
def test_get_analytics_sliding_window() -> None:
    assert (
        handler.get_analytics_sliding_window(
            SYMBOLS="AAPL,IBM",
            RANGE="2month",
            INTERVAL="DAILY",
            OHLC="close",
...
def test_get_fx_intraday() -> None:
    assert (
        handler.get_fx_intraday(from_symbol="EUR", to_symbol="USD", interval="5min")
        is not None
    )
    assert (
        handler.get_fx_intraday(
...
def test_get_fx_daily() -> None:
    ...
    assert (
        handler.get_fx_daily(from_symbol="EUR", to_symbol="USD", outputsize="full")
        is not None
    )
...
def test_get_crypto_intraday() -> None:
    assert (
        handler.get_crypto_intraday(symbol="ETH", market="USD", interval="5min")
        is not None
    )
    assert (
        handler.get_crypto_intraday(
...
def test_get_macdext() -> None:
    assert (
        handler.get_macdext(symbol="IBM", interval="daily", series_type="open")
        is not None
    )
...
def test_get_willr() -> None:
    assert (
        handler.get_willr(symbol="IBM", interval="daily", time_period="10") is not None
    )


def test_get_adxr() -> None:
    assert (
        handler.get_adxr(symbol="IBM", interval="daily", time_period="10") is not None
    )
...
def test_get_aroonosc() -> None:
    assert (
        handler.get_aroonosc(symbol="IBM", interval="daily", time_period="10")
        is not None
    )
...
def test_get_mfi() -> None:
    assert (
        handler.get_mfi(symbol="IBM", interval="weekly", time_period="10") is not None
    )
...
def test_get_ultosc() -> None:
    assert (
        handler.get_ultosc(symbol="IBM", interval="daily", timeperiod1="8") is not None
    )
...
def test_get_minus_di() -> None:
    assert (
        handler.get_minus_di(symbol="IBM", interval="weekly", time_period="10")
        is not None
    )
...
def test_get_plus_di() -> None:
    assert (
        handler.get_plus_di(symbol="IBM", interval="daily", time_period="10")
        is not None
    )
...
def test_get_minus_dm() -> None:
    assert (
        handler.get_minus_dm(symbol="IBM", interval="daily", time_period="10")
        is not None
    )
...
def test_get_plus_dm() -> None:
    assert (
        handler.get_plus_dm(symbol="IBM", interval="daily", time_period="10")
        is not None
    )
...
def test_get_midprice() -> None:
    assert (
        handler.get_midprice(symbol="IBM", interval="daily", time_period="10")
        is not None
    )
...
def test_get_natr() -> None:
    assert (
        handler.get_natr(symbol="IBM", interval="weekly", time_period="14") is not None
    )
...
def test_get_ht_trendline() -> None:
    assert (
        handler.get_ht_trendline(symbol="IBM", interval="daily", series_type="close")
        is not None
    )
...
def test_get_ht_sine() -> None:
    assert (
        handler.get_ht_sine(symbol="IBM", interval="daily", series_type="close")
        is not None
    )
...
def test_get_ht_trendmode() -> None:
    assert (
        handler.get_ht_trendmode(symbol="IBM", interval="weekly", series_type="close")
        is not None
    )
...
def test_get_ht_dcperiod() -> None:
    assert (
        handler.get_ht_dcperiod(symbol="IBM", interval="daily", series_type="close")
        is not None
    )
...
def test_get_ht_dcphase() -> None:
    assert (
        handler.get_ht_dcphase(symbol="IBM", interval="daily", series_type="close")
        is not None
    )
...
def test_get_ht_phasor() -> None:
    assert (
        handler.get_ht_phasor(symbol="IBM", interval="weekly", series_type="close")
        is not None
    )
